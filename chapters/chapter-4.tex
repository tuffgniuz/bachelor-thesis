...
\begin{figure}
    \includegraphics[width=\textwidth]{chapter-4/create-skf-project}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{chapter-4/skf-checklist-type}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{chapter-4/skf-maturity-level}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{chapter-4/skf-masvs-category}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{chapter-4/skf-sprint-configuration}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{chapter-4/skf-create-sprint}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{chapter-4/skf-submit-requirements}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{chapter-4/skf-security-requirements}
...
\begin{figure}[!t]
    ...
    \label{fig:sys-arch}
    \includegraphics[width=\textwidth]{chapter-4/system-arch}
\end{figure}
...
\begin{figure}
    \includegraphics[width=\textwidth]{chapter-4/}
\end{figure}
...
\begin{figure}[!h]
    \includegraphics[width=\textwidth]{chapter-4/auth-flow}
