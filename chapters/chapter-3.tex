This chapter is an analysis on SKF. First a background into the projectis provided. The study then describes the different phases where SKF is used to secure the SDLC.
...
\begin{figure}[!b]
    \centering
    \includegraphics[width=\textwidth]{chapter-3/skf-project.png}
    \caption{SKF Project}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{chapter-3/skf-new-project-form}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{chapter-3/skf-created-project}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{chapter-3/skf-project-features-list}
...
\begin{figure}[!h]
    ...
    \includegraphics[width=\textwidth]{chapter-4/OWASP-SAMM-model-600.png}
\end{figure}
