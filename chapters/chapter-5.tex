...
\paragraph{Authentication Backend}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{chapter-5/api-auth-backend}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{chapter-5/api-login-manager}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{chapter-5/api-include-auth-router}
    \caption{API auth router with fastapi-users}
    \label{code:api-auth-router}
\end{figure}

\subparagraph{Stateless Authentication}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{chapter-5/securestorage}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{chapter-5/authenticate}
